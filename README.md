...
[![Auto Release](https://github.com/ClosureScope/UniversityPhysicsII/actions/workflows/auto_release.yml/badge.svg)](https://github.com/ClosureScope/UniversityPhysicsII/actions/workflows/auto_release.yml)
[![Latest PDF](https://img.shields.io/badge/download-latest%20PDF-red)](https://github.com/ClosureScope/UniversityPhysicsII/releases/latest)
...
[**Releases → latest**](https://github.com/ClosureScope/UniversityPhysicsII/releases/latest). No need to clone or compile anything.
...
| `*.pdf` | Compiled output — built by CI, get it from [Releases](https://github.com/ClosureScope/UniversityPhysicsII/releases/latest) |
